                ...
                <div class="col-md-12">
                    <div class="card">
						...
						{{ csrf_field() }}
							...
							Tgl Periksa <br><input type="date" name="tgl_periksa" value="{{ $rm->tgl_periksa }}"> <br/>
							Diagnosa <br><input type="text" name="diagnosa" value="{{ $rm->diagnosa }}"> <br/>
							Keterangan <br><input type="text" name="keterangan" value="{{ $rm->keterangan }}"> <br/>
							Biaya Jasa <br><input type="number" name="biaya_jasa" value="{{ $rm->biaya_jasa }}"> <br/>
