...
class Petugas_AdminController extends Controller
{
	public function indexPetugas_Admin(Request $request)
    {
		...
		*/
		...
		return view('index/indexPetugas_Admin',compact('petugas_admin'),compact('users'));
	...
	public function tambahPetugas_Admin()
	{
		...
		return view('tambah/tambahPetugas_Admin',['users' => $users]);
	}
...
{
	$petugas_admin = DB::table('petugas_admin')->where('id_petugas',$id_petugas)->first();
	//petugas_admin = petugas_admin::find($id_petugas);
	
	$users = DB::table('users')->get();
	// passing data pegawai yang didapat ke view edit.blade.php
	return view('edit/editPetugas_Admin',['petugas_admin' => $petugas_admin,'users' => $users]);
}
